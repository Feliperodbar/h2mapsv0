...
const solarImage = "https://public.youware.com/users-website-assets/prod/478a89f9-ae01-4ec5-b8a1-ccce0e4c8a14/172e295f085644a5b02ccee379f4c3c3.jpg";
const windImage = "https://public.youware.com/users-website-assets/prod/478a89f9-ae01-4ec5-b8a1-ccce0e4c8a14/b91a0349369440c9bfd1c469d750a30a.jpg";
...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#technology" className="text-slate-600 hover:text-emerald-600 transition-colors">Tecnologia</a>
              <a href="#conservation" className="text-slate-600 hover:text-emerald-600 transition-colors">Conservação</a>
              <a href="#benefits" className="text-slate-600 hover:text-emerald-600 transition-colors">Benefícios</a>
              <a href="#contact" className="text-slate-600 hover:text-emerald-600 transition-colors">Contato</a>
              <Link 
                to="/dashboard" 
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-emerald-100">
            <div className="px-4 py-2 space-y-1">
              ...
              <a href="#technology" className="block px-3 py-2 text-slate-600 hover:text-emerald-600">Tecnologia</a>
              <a href="#conservation" className="block px-3 py-2 text-slate-600 hover:text-emerald-600">Conservação</a>
              <a href="#benefits" className="block px-3 py-2 text-slate-600 hover:text-emerald-600">Benefícios</a>
              <a href="#contact" className="block px-3 py-2 text-slate-600 hover:text-emerald-600">Contato</a>
              <Link 
                to="/dashboard" 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                ...
                Incluindo unidades de conservação da fauna e flora para desenvolvimento sustentável.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Ferramentas completas para análise georreferenciada e tomada de decisão inteligente
            </p>
          </motion.div>
      ...
      <section id="conservation" className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div
              initial={{ opacity: 0, x: -50 }}
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-emerald-600 to-teal-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Pronto para Revolucionar a Produção de Hidrogênio Verde?
            </h2>
            <p className="text-xl text-emerald-50 mb-8">
              Entre em contato conosco e descubra como nossa plataforma pode otimizar seus projetos de energia renovável.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/dashboard" 
                className="bg-white text-emerald-600 px-8 py-4 rounded-lg hover:bg-emerald-50 transition-colors font-semibold"
              >
                Começar Análise
              </Link>
      ...
      <footer className="bg-slate-900 text-slate-300 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#" className="hover:text-emerald-400 transition-colors">Tecnologia</a></li>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-sm text-slate-400">
            <p>&copy; 2025 H2maps. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
